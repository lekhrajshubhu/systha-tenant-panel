<template>
  <v-card class="pa-0" variant="flat">
    <v-card-title class="text-h6">Item Level Questions</v-card-title>
...
type ServiceDetail = {
  service_item_level_questions?: QuestionItem[];
};
...
const itemQuestions = computed(() => normalizeQuestions(props.service.service_item_level_questions));
</script>
