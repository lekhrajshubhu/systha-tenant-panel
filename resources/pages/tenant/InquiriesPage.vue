<template>
  <v-container class="py-6 px-14" fluid>
      ...
      <div class="pa-0">
      <div class="mb-4">
        <h2 class="pa-0">Inquiries List</h2>
       <v-card-subtitle class="pa-0">Manage customer inquiries and support requests</v-card-subtitle>
      </div>
        ...
        >
          ...
          <template #no-data>
            <div class="pa-12 text-center">
              ...
              <div class="text-h6 text-medium-emphasis">No offers found</div>
