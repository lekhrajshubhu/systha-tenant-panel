<template>
  <v-container class="py-6 px-14" fluid>
      ...
      <div class="pa-0">
      <div class="mb-4">
        <h2 class="pa-0">Appointment List</h2>
       <v-card-subtitle class="pa-0">Manage your scheduled service appointments</v-card-subtitle>
      </div>
        ...
        >
          ...
          <template #no-data>
            <div class="pa-12 text-center">
              <v-icon size="64" color="disabled" class="mb-4">mdi-minus-circle-outline</v-icon>
              <div class="text-h6 text-medium-emphasis">No appointment found</div>
